...
data_path = [
    '/home/luoyx/finetune/data/new11_6_without_multi/samples/samples.json',
]
data_root = '/home/luoyx/finetune/data/new11_6_without_multi/samples/'
...
image_folder = [
    '/home/luoyx/finetune/data/new11_6_without_multi/samples/',
]
launcher = 'pytorch'
llava_dataset = dict(
    data_paths=[
